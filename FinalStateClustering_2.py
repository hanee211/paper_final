...
def Clustering():
	...
	print("start 3000 Clustering!!")
	kmeans3000 = KMeans(n_clusters=3000, random_state=0).fit(final_state)
	with open('cluster_3000', 'wb') as file:
		pickle.dump(kmeans3000, file)					
		
	print("start 5000 Clustering!!")
	kmeans5000 = KMeans(n_clusters=5000, random_state=0).fit(final_state)
	with open('cluster_5000', 'wb') as file:
		pickle.dump(kmeans5000, file)			
